"""SAC online training demo: PocMan (discrete action space, lambda-envs).
...
Usage
-----
    python pocman_sac_mc.py                        # default settings
...
parser = argparse.ArgumentParser(
    ...
    description="SAC + MC critic on PocMan (discrete, lambda-envs).",
)
parser.add_argument(
    "--rounds",
    type=int,
